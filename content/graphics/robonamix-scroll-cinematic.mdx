...
These six frames are stills. The motion only exists on the live page, and I have not tried to fake the flight inside a gallery card, so if the interaction is the part you want to judge, [go and scroll the real thing](https://robonamix.com/inside-the-studio).
