...
metaDescription: "An agent drafts twice a week, a person moves the file out of _drafts. The approval is the commit, so the queue is visible instead of shipped."
