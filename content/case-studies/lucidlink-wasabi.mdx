---
title: "LucidLink + Wasabi for Broomstick Creative, replacing Dropbox with a streaming file system that survives event delivery"
...
Testing and rollout was led by Ops, with hands-on support from LucidLink during deployment. Special thanks to Marten Hylin at LucidLink for guidance on server selection, bucket planning, and troubleshooting the early latency issues.
