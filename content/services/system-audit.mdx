...
slug: "system-audit"
bucket: "audit"
tagline: "For a codebase written largely with AI, before a date that matters. Agent lanes hunt findings in parallel, a second pass tries to kill each one, and only the survivors reach you."
metaDescription: "For a codebase written largely with AI, before diligence, an acquisition or a compliance date. Parallel find pass, adversarial refutation. $6,500 fixed."
track: "ongoing"
order: 5
...
pricing: "$6,500 fixed for one codebase, with the scope agreed in writing before I start. No hourly, no open-ended discovery."
---

A codebase written largely with AI usually works. The question comes later, and from somebody else: an investor's technical diligence, an acquirer's review, a compliance window, an enterprise client's security questionnaire. That is a bad week to find out.

This review is for the weeks before that date.
...
And it is not an operations diagnostic. If the question is where your team's hours go rather than whether the code holds, start with the [Ops Leak Audit](/services/ops-leak-audit).
