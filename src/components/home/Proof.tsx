  ...
  return (
    <section>
      ...
      {/* Reference rank: this is a logo rail, not an argument, so the heading
          ...
          ink-200 rather than ink-300 because the MDX body directly below is
          ink-300 as well: at the old colour the heading matched its own lede
          and size was carrying the entire split. ink-200 still sits under the
          ink-100 the card h3s take and the #fafafa the act-openers inherit, so
      ...
      <div className="max-w-3xl text-ink-300">
        <MDX source={body} />
      </div>
      <Clients />
    </section>
