      ...
      {items.length === 0 ? (
        ...
        <div>
          {/* Counted from the loader, so the page cannot oversell itself as the
              list grows or thins. */}
          <div className="flex flex-wrap items-end justify-between gap-x-6 gap-y-2 font-mono text-label-sm uppercase text-ink-400">
            <p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <h2
                        className={`mt-3 font-semibold tracking-[-0.015em] text-ink-100 ${
